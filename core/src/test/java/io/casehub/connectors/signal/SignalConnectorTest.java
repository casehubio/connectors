...
class SignalConnectorTest {
    ...
    void setUp() {
        ...
        connector.apiUrl = Optional.of("http://localhost:" + wm.port());
        connector.number = Optional.of("+15551000000");
    }
    ...
    void send_returns_false_when_not_configured() {
        ...
        unconfigured.apiUrl = Optional.empty();
        unconfigured.number = Optional.empty();
